...
import 'add_transaction_page.dart'; // Keep if needed for type reference, otherwise remove
...
class LaporanPageState extends State<LaporanPage> {
  ...
  Widget _buildTransactionList(BuildContext context) {
     if (_groupedTransactions.isEmpty) {
        return const Center(child: Padding(padding: EdgeInsets.symmetric(vertical: 40.0), child: Text("Belum ada transaksi bulan ini.\nTekan '+' untuk menambah.", textAlign: TextAlign.center, style: TextStyle(color: Colors.grey, fontSize: 16))));
     }
